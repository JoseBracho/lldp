        ...
        for ip in active_ips:
            ...
            try:
                ...
                if len(nameDevice) > 0 and len(infovendor) > 0:
                    nickname = nameDevice.split('-')[1] #Para identificar a que nodo pertenece el equipo
                    vendor = [vendor for vendor in info if vendor[1] in infovendor] #para obtener el modelo del equipo
                    for nodo in nodos:
                        if nickname in nodo:
                ...
                print(ip,nameDevice, infovendor)
        return devices
